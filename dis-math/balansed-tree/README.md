...
- **Малое левое/правое вращение** - Объявим корнем левого/правого сына вершины, а левое/правое поддерево переподвесим. За это в коде отвечают `__sl_rotation` и `__sr_rotation`, а сама реализация обобщена в `__rotation`.
