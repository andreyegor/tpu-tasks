...
SELECT last_name,
    hire_date
FROM hr.employees
WHERE hire_date BETWEEN '1987-01-01' AND '1994-12-31'
...
SELECT DISTINCT FORMAT('%s %s', first_name, last_name) as full_name,
    email
FROM hr.employees
WHERE (
