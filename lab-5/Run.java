...
public class Run {
    private final String FILE_NOT_FOUND_MSG = "По пути %s файл не найден.\n";
    private final String FILES_NOT_FOUND_MSG = "Ни один файл не найден.\n";
    private final String CANT_START_WRITE_MSG = "Не получилось начать запись данных.\n";
    private final String CANT_READ_MSG = "Не получилось начать чтение данных.\n";
    private final String CANT_WRITE_MSG = "Что-то пошло не так во время записи данных.\n";
    private final String CANT_PARSE_MSG = "Не получилось прочитать аргументы командной строки:\n%s";
    private final String CANT_CLOSE_MSG = "Что-то пошло не так во время закрытия файла.\n";
    private final String SHOW_ALL_HORISONTAL_MSG = "Невозможно выровнять горизонтальный график если включено отображение невидимых символов, используйте вертикальный график.\n";

    private final String SORT_BY_COUNT_FLG = "-count";
    private final String SORT_DESCEDENTING_FLG = "-desk";
    private final String HORISONTAL_PLOT_FLG = "-horizontal";
    private final String SHOW_ALL_SYMBOLS_FLG = "-all";
    private final String IGNORE_CASE_FLG = "-ignoreCase";
    private final String DATA_OUTPUT_FLG = "-out";
